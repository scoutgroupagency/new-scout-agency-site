    ...
    <section className="min-h-[60vh]">
      <div className=" bg-scoutGreen4 flex flex-wrap-reverse md:flex-nowrap justify-between items-center gap-12">
        <div className="w-full lg:w-6/12  space-y-6 pl-4 lg:pl-40">
          ...
          <p className=" leading-8 text-slate-100 px-2 pb-10">
        ...
        <div className="min-h-[60vh] w-full lg:w-6/12 bg-green-200 bg-[url('https://res.cloudinary.com/dh8qlzbzk/image/upload/v1757586690/about-us-section_image_r5qyqq_yaynka.webp')] bg-cover bg-center">
          {/* <CloudinaryImage
