...
export default function ActiviesSection() {
  return (
    <section className="min-h-screen bg-green-200 bg-[url('https://res.cloudinary.com/dh8qlzbzk/image/upload/v1757586887/zurura_activities_bg_darken_image_nxznf8_vu8com.webp')] bg-cover bg-center">
