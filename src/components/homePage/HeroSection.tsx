...
export default function HeroSection() {
  return (
    <>
      <section className="min-h-[90dvh] bg-green-200 bg-[url('https://res.cloudinary.com/dh8qlzbzk/image/upload/v1757586549/scout_home_Hero_image_c0mmak_vn8g1b.webp')] bg-no-repeat bg-cover bg-bottom">
